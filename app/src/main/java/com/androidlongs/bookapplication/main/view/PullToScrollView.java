...
/**
 * Created by androidlongs on 16/12/30.
 * 站在顶峰，看世界
 * 落在谷底，思人生
 */
...
public class PullToScrollView extends ScrollView {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isNeedMove()) {
                    if (normalRect.isEmpty()) {
                        // 保存正常的布局位置  
                        normalRect.set(childView.getLeft(), childView.getTop(),
    ...
    public void animation() {
        ...
        // 设置回到正常的布局位置  
        childView.layout(normalRect.left, normalRect.top, normalRect.right, normalRect.bottom);
        normalRect.setEmpty();
    }
